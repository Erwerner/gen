...
public class Config {
	...
	public static final int foodSupply = 50 * cSoupFctor * cSoupFctor;
	public static int cPartnerSupply = foodSupply / 3;
	public static final int cLifeEnergyCount = 2;
	public static final int cMoveEnergyCount = 1;
	public static final int cFoodEnergy = (cLifeEnergyCount + cMoveEnergyCount ) * 40;
